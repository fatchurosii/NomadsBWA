 ...
 <div class="container">
    ...
    <img src="{{url('frontend/images/logo.png')}}" alt="Logo NOMADS">
        ...
        <button
        class="navbar-toggler navbar-toggler-right mt-1"
        type="button"
        ...
        <div class="collapse navbar-collapse " id="navb">
            <ul class="navbar-nav ml-auto mr-3">
                ...
                <button class="btn btn-login btn-navbar my-2 my-sm-0 " type="button" onclick="event.preventDefault();location.href='{{url('login')}}';">Masuk</button>
                </form>
            ...
            <form class="form-inline d-sm-block d-md-none" action="{{url('logout')}}" method="POST">
                @csrf
                <button class="btn btn-login btn-navbar my-2 my-sm-0" type="submit">Keluar</button>
            </form>
