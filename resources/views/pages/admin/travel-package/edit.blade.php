   ...
   <div class="card shadow">
       ...
       <form action="{{route('travel-package.update',$item->id)}}" method="POST">
        ...
        <div class="form-group">
            ...
            <textarea name="about" rows="10" class="d-blok w-100 form-control">
                {{$item->about}}
            </textarea>
        </div>
        <div class="form-group">
            <label for="featured_event">Featured Evenet</label>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="languange" placeholder="Languange" value="{{$item->languange}}">
        </div>
        <div class="form-group">
